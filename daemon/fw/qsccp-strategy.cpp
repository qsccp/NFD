...
namespace nfd
{
    namespace fw
    {
        ...
        NFD_REGISTER_STRATEGY(QSCCPStrategy);
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //// QSCCPStrategy
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                             ...
                                             const Data &data)
        {
            ...
            for (const auto &pendingDownstream : pendingDownstreams)
            {
                ...
                this->sendData(pitEntry, data, egress.face);
                // downStreamNum++;
            }
        ...
        face::FaceId RateCollection::selectFaceByRatio(const FaceEndpoint &ingress, const fib::Entry &fibEntry, const ndn::Interest &interest)
        {
            if (this->items.empty())
            {
                ...
                {
                    this->addOrUpdateRate(nexthop.getFace().getId(), 200000);
                }
        ...
        void RateCollection::calSplitRateByRate()
        {
            ...
            if (this->items.size() == 1)
            {
                this->items[0]->allocateRate = this->items[0]->rateValue < this->totalAvaliableRate ? this->items[0]->rateValue : this->totalAvaliableRate;
                return;
            }
        ...
        RateStore::periodicCleaning()
        {
            ...
            if (turn % 1 == 0)
            {
                ...
                {
                    it->second->doPeriodicCleaning(false, 200000);
                }
            }
            // for (auto it = this->ART.begin(); it != this->ART.end(); it++) {
                                       ...
                                       const Data &data)
        {
            ...
            // if (flowKey == "/C") {
            //     std::cout << "mergeRate: " << mergeRate << std::endl;
            //     this->RRT[flowKey]->printItems();
            // }
